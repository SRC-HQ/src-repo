...
const PROGRAM_ID = new PublicKey(process.env.NEXT_PUBLIC_PROGRAM_ID ?? '2y2AdrVLKqwcA5GQEC1ULEHac3hH9ck565UBqzPaReJZ');
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="flex p-6 gap-6 h-[calc(100vh-80px)]">
        {/* E2E target: log line for end-to-end testing */}
        <div className="flex-1 bg-gray-900 rounded-2xl border border-gray-800 flex flex-col items-center justify-center p-6">
          <p className="text-gray-500 italic mb-4">Gameplay Visualization Area</p>
          <pre
            data-testid="e2e-distribution-log"
            className="text-sm text-gray-400 font-mono bg-gray-800 p-4 rounded-lg"
          >
            [Nest] 4055  - 02/10/2026, 11:42:14 AM     LOG [GameGateway] Broadcasting distribution: 0 winners
          </pre>
        </div>
